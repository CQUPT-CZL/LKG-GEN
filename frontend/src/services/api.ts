...
export const apiService = {
  ...
  // Chat 模拟接口
  chatMock: (message: string, conversationId?: string): Promise<{ reply: string; conversation_id: string; created_at: string }> =>
    api.post('/chat/mock', { message, conversation_id: conversationId }),
};
